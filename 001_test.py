...
RPC_ENDPOINT_URL = "https://api.devnet.solana.com" #https://api.devnet.solana.com #https://api.mainnet-beta.solana.com/
SOL_USDC_WHIRLPOOL_PUBKEY = PublicKey("847gd7SckNwJetbjf22ktip9vAtKWPMY4ntdr6CdCsJj")
